...
class SubScene(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        try:
            ...
            self.updateChecker('5742')
        if len(argv)==1:
            wx.Frame.__init__(self, parent, id, 'Subtitle Finder V_{}'.format(self.version), size=(600, 500))#350,280
            #self.SetBackgroundColour('BLACK')
            self.CenterOnScreen(wx.BOTH)
            panel=wx.Panel(self)
            ...
            h1 = TransparentText(self.bitmap1, -1, 'Subtitle Finder', (115, 130))
            hfont = wx.Font(45, wx.MODERN, wx.ITALIC, wx.NORMAL)
            h1.SetFont(hfont)
            ...
            try:
                ...
                b1=wx.Button(self.bitmap1, -1, 'Install The Software', pos=(205, 300), size=(180, 30))
                self.Bind(wx.EVT_BUTTON, self.install, b1)
            b2=wx.Button(self.bitmap1, -1, 'Search For Local File', pos=(395, 330), size=(180, 30))
            b3=wx.Button(self.bitmap1, -1, 'Select Language', pos=(205, 360), size=(180, 30))
            b4=wx.Button(self.bitmap1, -1, 'About', pos=(395, 390), size=(180, 30))
            b5=wx.Button(self.bitmap1, -1, 'Exit', pos=(205, 420), size=(180, 30))
            ...
            self.Bind(wx.EVT_BUTTON, self.closeButton, b5)

            b=wx.Button(self.bitmap1, -1, '', pos=(386, 300), size=(8, 150))
            b.Disable()

            t2=TransparentText(self.bitmap1, -1, 'Made By: Xayed © 2019', pos=(330, 500), size=(160, 20))
