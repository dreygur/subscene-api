...
from installHelper import install
...
class SubScene(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        if len(argv)==1:
            wx.Frame.__init__(self, parent, id, 'Subtitle Finder {}'.format(self.version), size=(350, 280))
            self.SetBackgroundColour('BLACK')
            self.CenterOnScreen(wx.BOTH)
            panel=wx.Panel(self)
            ...
            if not path.exists(r"C:\Program Files\Subtitle Finder\Subtitle_Finder_V2.7.exe"):
                ...
                b2=wx.Button(panel, -1, 'Search For Local File', pos=(50, 70), size=(230, 30))
                b3=wx.Button(panel, -1, 'About', pos=(50, 120), size=(230, 30))
                b4=wx.Button(panel, -1, 'Exit', pos=(50, 170), size=(230, 30))
    ...
    def aboutButton(self, e):
        ...
        Changelog 29-08-2019 (v2.7):
          * Added Install Option
          * Added 'Download Subtitle' in Right Click Menu
        ...
        info.SetWebSite('http://facebook.com/xayed42')
