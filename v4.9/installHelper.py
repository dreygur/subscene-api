...
def install(e=''):
    ...
    if run_as_admin() is True:
        name='Subtitle_Finder_V4.9.exe'
        rd1 = '\"C:\\Program Files\\Subtitle Finder\\{}\" \"%1\"\"'.format(name)
        rd2 = "C:\\Program Files\\Subtitle Finder"
        rd3 = '\"C:\\Program Files\\Subtitle Finder\\{}\" langChoice \"%1\"\"'.format(name)
        '''for e in extList:
        ...
        for e in extList:
                contextAdderForVideoFiles(e, 'Download Subtitle', rd1, 'Download Subtitle in English')
                contextAdderForVideoFiles(e, 'Download Subtitle in Other Language', rd3, 'Download Subtitle in Other Language')
